...
const weapon = {
  // Lets create array variables for this Object
  swords: ["Lightning Sword", "Amaterasu Sword", "Wind Blade"],
  elements: ["Lightning", "Earth", "Wind", "Water"],
  damage: ["100", "300", "600"],
};

// Getting the first value of sword
console.log(`Sword index [0]: ${weapon.swords[0]}`);
